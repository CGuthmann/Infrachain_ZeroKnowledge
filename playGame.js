...
const {encrypt} = require("./elgamal-babyjub/ts/index");
...
async function main() {
    ...
    // const elGamalPrivKey = genPrivKey();
    // const elGamalPubKey = genPubKey(elGamalPrivKey);
    ...
    */
    ...
    let {
        proof,
        publicSignals
    } = await snarkjs.groth16.fullProve(input_A, "circuits/circuit_participant_js/circuit_participant.wasm", "circuits/circuit_participant_0001.zkey");
    ...
    console.log('calldata before 1', calldata);
...

    {
        let {
            proof,
            publicSignals
        } = await snarkjs.groth16.fullProve(input_B, "circuits/circuit_participant_js/circuit_participant.wasm", "circuits/circuit_participant_0001.zkey");
        ...
        */
        ...
        let calldata = await groth16ExportSolidityCallData(proof, publicSignals);
        console.log('calldata before 2', calldata);
...

    {
        let {
            proof,
            publicSignals
        } = await snarkjs.groth16.fullProve(input_C, "circuits/circuit_participant_js/circuit_participant.wasm", "circuits/circuit_participant_0001.zkey");
        ...
        */
        ...
        let calldata = await groth16ExportSolidityCallData(proof, publicSignals);
        console.log('calldata before 3', calldata);
...

    {
        let {
            proof,
            publicSignals
        } = await snarkjs.groth16.fullProve(input_total, "circuits/circuit_total_js/circuit_total.wasm", "circuits/circuit_total_0001.zkey");
        ...
        */
        ...
        let calldata = await groth16ExportSolidityCallData(proof, publicSignals);
        console.log('calldata before 4', calldata);
...

    {
        let {
            proof,
            publicSignals
        } = await snarkjs.groth16.fullProve(input_claimA, "circuits/circuit_claim_js/circuit_claim.wasm", "circuits/circuit_claim_0001.zkey");
