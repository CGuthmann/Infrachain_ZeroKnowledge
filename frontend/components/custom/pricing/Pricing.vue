      ...
      <v-container>
        ...
        <v-row class="mt-13" justify="center">
          <v-col cols="12" md="6" lg="4">
            <v-card outlined elevation="0" class="pricing-card overflow-hidden mb-15">
              <v-card-text class="text-center pa-15">
                <h5 class="font-weight-regular font-18">Token balance</h5>
                <div>
                  <sup>ETH</sup>
          ...
          <v-col cols="12" md="6" lg="4">
            <v-card outlined elevation="0" class="pricing-card overflow-hidden mb-15">
              ...
              <v-btn block large depressed color="error" class="text-uppercase rounded-t-0">
                Choose Plan
              </v-btn>
            </v-card>
          </v-col>
