...
export async function initWeb3() {
  ...
  if (typeof window.ethereum !== 'undefined') {
    console.debug("initWeb3() is(window.ethereum) >> ", !!window.ethereum)
    web3 = new Web3(window.ethereum);
    console.debug("initWeb3() web3 >> ", web3)

    await window.ethereum.enable();
    console.debug("initWeb3() enabled web3 >> ", web3)

    const walletAddress = "0xd2f82E45C337Ea7Af8F9f59F185fAc420DcdD459";
    const balance = await web3.eth.getBalance(walletAddress);
    console.debug("initWeb3() balance >> ", balance);

    const collateralTokenContractABI = [
      {
        "inputs": [
          {
    ...
    const collateralTokenContractAddress = "0x71bA4cC2D19Eb7AE982C32DaD6AEE81b55f25F51"

    const instanceCollateralToken = new web3.eth.Contract(
      collateralTokenContractABI,
