...
async function main() {
	...
	*/
	...
	const { proof, publicSignals } = await snarkjs.groth16.fullProve(input_A, "circuits/circuit_participant_js/circuit_participant.wasm", "circuits/circuit_participant_0001.zkey");
